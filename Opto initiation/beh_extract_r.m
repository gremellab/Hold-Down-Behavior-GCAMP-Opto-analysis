function crf60analog = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   CRF60ANALOG = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   CRF60ANALOG = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   crf60analog = importfile('01-crf60-analog.csv', 2, 1376751);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/04/02 10:11:07
