function crf60tracking = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   CRF60TRACKING = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   CRF60TRACKING = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   crf60tracking = importfile('01-crf60-tracking.csv', 1, 70018);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/04/02 10:04:44
...
crf60tracking = [dataArray{1:end-1}];
